...
net-nomad-hcx: net-nomad-hcx.o libhcxdumptool.a libhcxpcapngtool.a
	g++ -w -o net-nomad-hcx_$(ARCH) net-nomad-hcx.cpp -Llib -L/usr/local/ssl/lib -I/usr/local/ssl/include -Iinclude -Ihcxpcapngtool/include/pcapngtool/ -lhcxdumptool -lhcxpcapngtool -lssl -lz -lbz2 -llzma -larchive -lcrypto -lz -lpcap -lcjson -lfmt
...
hcxpcapngtool.o: hcxpcapngtool/hcxpcapngtool.c
	gcc -w -c -fPIC hcxpcapngtool/hcxpcapngtool.c -Llib -L/usr/local/lib -L /usr/local/ssl/lib -I/usr/include -Ihcxpcapngtool/include/pcapngtool/ -Ihcxpcapngtool/include -I/usr/local/ssl/include -I/usr/local/include -I/usr/local/include/cjson -lssl -lcrypto -lcjson -lz -lbz2 -llzma -larchive
